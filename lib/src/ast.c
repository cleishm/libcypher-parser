...
struct cypher_astnode_vts
{
    ...
    const struct cypher_astnode_vt *drop_node_props_index;
    ...
    const struct cypher_astnode_vt *range_plus;
    const struct cypher_astnode_vt *range_optional;
...
static const struct cypher_astnode_vts cypher_astnode_vts =
{
    ...
    .drop_node_props_index = &cypher_drop_node_props_index_astnode_vt,
    ...
    .range_plus = &cypher_range_plus_astnode_vt,
...
const uint8_t CYPHER_AST_DROP_NODE_PROPS_INDEX =
        VT_OFFSET(drop_node_props_index);
...
const uint8_t CYPHER_AST_RANGE_PLUS = VT_OFFSET(range_plus);
const uint8_t CYPHER_AST_RANGE_OPTIONAL = VT_OFFSET(range_optional);
